            ...
            <nav class="horizontal-nav mobile-navbar fixed-navbar">
                <div class="collapse navbar-collapse" id="navbar-menu">
                  <ul class="horizontal-menu">
                    ...
                    <li class="dropdown">
                        <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/images/svg-icon/apps.svg" class="img-fluid" alt="apps"><span>Apps</span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{url('/apps-kanban-board')}}"></i>Kanban Board</a></li>
                            <li><a href="{{url('/apps-onboarding-screens')}}"></i>Onboarding Screens</a></li>
                        </ul>
                    </li>                            
                    <li class="dropdown">
                        <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/images/svg-icon/components.svg" class="img-fluid" alt="components"><span>Components</span></a>
                        <ul class="dropdown-menu">
                            <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown" >eCommerce</a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown">User</a>
                                <ul class="dropdown-menu">
                    ...
                    <li class="scroll"><a href="{{url('/widgets')}}"><img src="assets/images/svg-icon/widgets.svg" class="img-fluid" alt="widgets"><span>Widgets</span></a></li>
                    <li class="dropdown menu-item-has-mega-menu">
                        <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/images/svg-icon/basic.svg" class="img-fluid" alt="basic"><span>Basic UI</span></a>
                    ...
                    <li class="dropdown">
                        <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/images/svg-icon/advanced.svg" class="img-fluid" alt="advanced"><span>Advanced UI</span></a>
                        <ul class="dropdown-menu">
