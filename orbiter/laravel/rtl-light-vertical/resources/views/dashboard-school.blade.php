                    ...
                    <div class="card m-b-30">
                        <div class="card-header">                                
                            <div class="row align-items-center">
                                ...
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetStudent" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="widgetStudent">
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetHod" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
