            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetPatientTypes" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetAppointment" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                ...
                <div class="card-body appointment-widget">
                    ...
                    <ul class="list-unstyled py-3 pr-0">
                        <li><i class="mdi mdi-circle text-primary ml-2"></i> Website</li>
                        <li><i class="mdi mdi-circle text-success ml-2"></i> Phone Call</li>
                        <li><i class="mdi mdi-circle text-light ml-2"></i> App</li>
                    </ul>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetDepartment" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetBestDoctors" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                ...
                <div class="card-body py-0">
                    <ul class="list-unstyled pr-0">
                        <li class="media">
                            <img class="ml-3 rounded-circle" src="assets/images/users/men.svg" alt="Generic placeholder image">
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Dr. Shriram Ramesh<span class="badge badge-warning-inverse float-left font-14">4.5</span></h5>
                            <p class="mb-0">M.D. (Medicines), M.S. (Gynecology)</p>
                            </div>
                        </li>
                        <li class="media my-4">
                            <img class="ml-3 rounded-circle" src="assets/images/users/boy.svg" alt="Generic placeholder image">
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Dr. Andrew Garfield<span class="badge badge-warning-inverse float-left font-14">4.0</span></h5>
                            <p class="mb-0">Internist, Pharmacy Care Doctor</p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="ml-3 rounded-circle" src="assets/images/users/women.svg" alt="Generic placeholder image">
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Dr. Naomi Wattson<span class="badge badge-warning-inverse float-left font-14">3.5</span></h5>
                        ...
                        <li class="media my-4">
                            ...
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Dr. Mark Wahlberg<span class="badge badge-warning-inverse float-left font-14">3.0</span></h5>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetNotifications" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                ...
                <div class="card-body py-0">
                    <ul class="list-unstyled pr-0">
                        <li class="media">
                            ...
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Amy Ahuja transfered<span class="float-left text-muted font-11 mt-1">02:39 pm</span></h5>
                        ...
                        <li class="media my-4">
                            ...
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Received Supply<span class="float-left text-muted font-11 mt-1">10:23 pm</span></h5>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Dr. Shriram is on leave<span class="float-left text-muted font-11 mt-1">04:51 pm</span></h5>
                        ...
                        <li class="media my-4">
                            ...
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">Surgery Successful<span class="float-left text-muted font-11 mt-1">05:12 pm</span></h5>
            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link p-0 font-18 float-left" type="button" id="widgetPatientStatus" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
