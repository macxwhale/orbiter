                ...
                <div class="card email-open-box m-b-30">
                    <div class="card-header">
                        <ul class="list-inline mb-0 pr-0">
                            ...
                            <li class="list-inline-item float-left"><a href="#"><i class="feather icon-folder font-20"></i></a></li>
                            <li class="list-inline-item float-left"><a href="#"><i class="feather icon-printer font-20"></i></a></li>
                        </ul>
                    </div>
                    <div class="card-body">                                    
                        <div class="row m-b-30">
                            <div class="col-md-5">
                                <div class="media">
                                  <img class="align-self-center ml-3" src="assets/images/users/men.svg" alt="Generic placeholder image">
