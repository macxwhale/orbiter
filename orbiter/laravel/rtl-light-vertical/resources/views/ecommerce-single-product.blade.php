                    ...
                    <div class="tab-content" id="defaultTabContentLine">
                        ...
                        <div class="tab-pane fade" id="review-line" role="tabpanel" aria-labelledby="review-tab-line">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="assets/images/users/men.svg" class="img-fluid ml-3" alt="user">
                                ...
                                <li class="media my-4">
                                    <img src="assets/images/users/boy.svg" class="img-fluid ml-3" alt="user">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img src="assets/images/users/girl.svg" class="img-fluid ml-3" alt="user">
                                    <div class="media-body">
