                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="ecommerce-single-product.html"><img src="assets/images/ecommerce/product_img_01.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="ecommerce-single-product.html"><img src="assets/images/ecommerce/product_img_06.jpg" class="img-fluid" alt="product"></a>
