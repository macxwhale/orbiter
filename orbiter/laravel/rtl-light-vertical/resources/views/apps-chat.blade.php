                    ...
                    <ul class="list-unstyled mb-0 pr-0">
                        <li class="media">
                            ...
                            <div class="media-body">
                                <h5>Amy Adams<span class="badge badge-success mr-2">1</span> <span class="timing">Jan 22</span></h5>
                                <p>Admin</p>
                            </div>
                        </li>
                        <li class="media">
                            ...
                            <div class="media-body">
                                <h5>James Simmy<span class="badge badge-success mr-2">2</span> <span class="timing">Feb 15</span></h5>
                                <p>HR Executive</p>
                            </div>
                        </li>
                        <li class="media">
                            ...
                            <div class="media-body">
                                <h5>Mark Wither<span class="badge badge-success mr-2">3</span> <span class="timing">Mar 03</span></h5>
                                <p>Manager</p>
                            </div>
                        </li>
                        <li class="media">
                            ...
                            <div class="media-body">
                                <h5>Steve Jason<span class="badge badge-success mr-2">1</span> <span class="timing">Jan 22</span></h5>
                                <p>Data Analyst</p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/images/users/girl.svg" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5>Brad Pitt<span class="badge badge-success mr-2">2</span> <span class="timing">Feb 15</span></h5>
                                <p>Actor</p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/images/users/boy.svg" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5>Will Smith<span class="badge badge-success mr-2">3</span> <span class="timing">Mar 03</span></h5>
                                <p>Product Manager</p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/images/users/men.svg" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5>Courtney Doe<span class="badge badge-success mr-2">1</span> <span class="timing">Jan 22</span></h5>
                                <p>PHP Developer</p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/images/users/women.svg" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5>Jenni Wills<span class="badge badge-success mr-2">2</span> <span class="timing">Feb 15</span></h5>
                                <p>HR Executive</p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/images/users/boy.svg" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5>Sam Peterson<span class="badge badge-success mr-2">3</span> <span class="timing">Mar 03</span></h5>
                                <p>Marketing Head</p>
                            </div>
                        </li>
                        <li class="media">
        ...
        <div class="col-lg-7 col-xl-8">       
            <div class="chat-detail">
                <div class="chat-head">
                    <ul class="list-unstyled mb-0 pr-0">
                        <li class="media">
                            <img class="align-self-center ml-3 rounded-circle" src="assets/images/users/girl.svg" alt="Generic placeholder image">
                            <div class="media-body">
