            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link mb-2 active" id="v-pills-dashboard-tab" data-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="true"><i class="feather icon-grid ml-2 mt-1 float-right"></i>Dashboard</a>
                        <a class="nav-link mb-2" id="v-pills-order-tab" data-toggle="pill" href="#v-pills-order" role="tab" aria-controls="v-pills-order" aria-selected="false"><i class="feather icon-package ml-2 mt-1 float-right"></i>My Orders</a>
                        <a class="nav-link mb-2" id="v-pills-addresses-tab" data-toggle="pill" href="#v-pills-addresses" role="tab" aria-controls="v-pills-addresses" aria-selected="false"><i class="feather icon-map-pin ml-2 mt-1 float-right"></i>My Addresses</a>
                        <a class="nav-link mb-2" id="v-pills-wishlist-tab" data-toggle="pill" href="#v-pills-wishlist" role="tab" aria-controls="v-pills-wishlist" aria-selected="false"><i class="feather icon-heart ml-2 mt-1 float-right"></i>Wishlist</a>
                        <a class="nav-link mb-2" id="v-pills-wallet-tab" data-toggle="pill" href="#v-pills-wallet" role="tab" aria-controls="v-pills-wallet" aria-selected="true"><i class="feather icon-credit-card ml-2 mt-1 float-right"></i>Wallet</a>
                        <a class="nav-link mb-2" id="v-pills-chat-tab" data-toggle="pill" href="#v-pills-chat" role="tab" aria-controls="v-pills-chat" aria-selected="false"><i class="feather icon-message-circle ml-2 mt-1 float-right"></i>My Chat</a>
                        <a class="nav-link mb-2" id="v-pills-notifications-tab" data-toggle="pill" href="#v-pills-notifications" role="tab" aria-controls="v-pills-notifications" aria-selected="false"><i class="feather icon-bell ml-2 mt-1 float-right"></i>Notifications</a>
                        <a class="nav-link mb-2" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="feather icon-user ml-2 mt-1 float-right"></i>My Profile</a>
                        <a class="nav-link" id="v-pills-logout-tab" data-toggle="pill" href="#v-pills-logout" role="tab" aria-controls="v-pills-logout" aria-selected="false"><i class="feather icon-log-out ml-2 mt-1 float-right"></i>Logout</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card border m-b-30">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <h6 class="mb-0 text-left">Total : <strong>$500</strong></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <h6 class="mb-0 text-left"><button class="btn btn-success-rgba font-16"><i class="feather icon-file mr-2"></i>Invoice</button></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border m-b-30">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <h6 class="mb-0 text-left">Total : <strong>$100</strong></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="wallet-box">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="mb-0 text-left"><button class="btn btn-success-rgba font-16"><i class="feather icon-plus mr-2"></i>Add Money</button></p>
                                    </div>
                                </div>
                            </div>                                        
                        </div>
                        ...
                        <div class="card-body">
                            <div class="ecom-notification-box">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-success-inverse"><i class="feather icon-check"></i></span>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-primary-inverse"><i class="feather icon-calendar"></i></span>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-danger-inverse"><i class="feather icon-alert-triangle"></i></span>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <span class="ml-3 action-icon badge badge-warning-inverse"><i class="feather icon-award"></i></span>
                                        <div class="media-body">
