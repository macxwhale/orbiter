            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <div class="dropdown">
                                <button class="btn btn-link l-h-20 p-0 font-18 float-left" type="button" id="CustomdropdownMenuButton8" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="CustomdropdownMenuButton8">
            ...
            <div class="card m-b-30 quote-bg">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        ...
                        <div class="col-10">
                            <h5 class="card-title mb-0 text-left">Quote of the Day</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body text-center">
