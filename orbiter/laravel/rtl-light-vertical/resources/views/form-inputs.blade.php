    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Usage <code>placeholder="name</code></h6>
        ...
        <div class="col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Usage <code>value="name</code></h6>
                    <div class="form-group">
        ...
        <div class="col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Usage <code>minLength="name</code></h6>
                    <div class="form-group">
        ...
        <div class="col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Usage <code>maxLength="name</code></h6>
                    <div class="form-group">
