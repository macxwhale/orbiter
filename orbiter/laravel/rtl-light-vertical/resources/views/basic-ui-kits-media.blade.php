            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="media m-b-30">
                        <img class="align-self-start ml-3 rounded-circle" src="assets/images/users/men.svg" alt="Generic placeholder image">
                        <div class="media-body">
                    ...
                    <div class="media m-b-30">
                        <img class="align-self-center ml-3 rounded-circle" src="assets/images/users/women.svg" alt="Generic placeholder image">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img class="align-self-end ml-3 rounded-circle" src="assets/images/users/boy.svg" alt="Generic placeholder image">
                        <div class="media-body">
