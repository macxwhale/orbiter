    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="media">
                        <img class="ml-3 rounded-circle" src="assets/images/crypto/bitcoin.png" alt="Generic placeholder image">
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="media">
                        <img class="ml-3 rounded-circle" src="assets/images/crypto/ethereum.png" alt="Generic placeholder image">
                        <div class="media-body">
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="media">
                        <img class="ml-3 rounded-circle" src="assets/images/crypto/ripple.png" alt="Generic placeholder image">
                        <div class="media-body">
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="media">
                        <img class="ml-3 rounded-circle" src="assets/images/crypto/bcc.png" alt="Generic placeholder image">
                        <div class="media-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h4 class="mb-5">USD to ATC <span class="float-left"><i class="feather icon-chevron-left mr-2"></i><i class="feather icon-chevron-right"></i></span></h4>
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h4 class="mb-5">ATC to USD <span class="float-left"><i class="feather icon-chevron-left mr-2"></i><i class="feather icon-chevron-right"></i></span></h4>
                    <div class="input-group mb-3">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body py-0">
                    ...
                    <ul class="list-unstyled pr-0">
                        <li class="media">
                            <img class="ml-3 rounded-circle" src="assets/images/crypto/bitcoin_small.png" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5 class="mt-0 mb-1 font-16">Bitcoin (BTC)<span class="float-left text-success font-14 mt-1">+BTC 5.26</span></h5>
                                <p class="mb-0"><i class="feather icon-arrow-left mr-2"></i>Bought - Today, 15:32<span class="float-left text-muted font-12 mt-1">= $20.89</span></p>
                            </div>
                        </li>
                        <li class="media my-4">
                            <img class="ml-3 rounded-circle" src="assets/images/crypto/ethereum_small.png" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5 class="mt-0 mb-1 font-16">ETH to RPH<span class="float-left text-success font-14 mt-1">+RPH 15.52</span></h5>
                                <p class="mb-0"><i class="feather icon-arrow-left mr-2"></i>Exchanged - Yesterday, 09:42<span class="float-left text-muted font-12 mt-1">= $15</span></p>
                            </div>
                        </li>
                        <li class="media">
                            <img class="ml-3 rounded-circle" src="assets/images/crypto/ripple_small.png" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5 class="mt-0 mb-1 font-16">Ripple<span class="float-left text-success font-14 mt-1">+Ripple 3.28</span></h5>
                                <p class="mb-0"><i class="feather icon-arrow-left mr-2"></i>Bought - Yesterday, 18:20<span class="float-left text-muted font-12 mt-1">= $20.89</span></p>
                            </div>
                        </li>
                        <li class="media my-4">
                            <img class="ml-3 rounded-circle" src="assets/images/crypto/bcc_small.png" alt="Generic placeholder image">
                            <div class="media-body">
                                <h5 class="mt-0 mb-1 font-16">Bitcoin Cash<span class="float-left text-success font-14 mt-1">+BTC 1.63</span></h5>
                                <p class="mb-0"><i class="feather icon-arrow-left mr-2"></i>Exchanged - 21 Feb, 04:25<span class="float-left text-muted font-12 mt-1">= $33.72</span></p>
                            </div>
                        </li>
                    </ul>
                </div>
